var nama = ["Jericho Nathanael Chrisnanta",
...
var dosen = [
  ...
  autocomplete(document.getElementById("fname"), nama);
  autocomplete(document.getElementById("fdosen"), dosen);

  document.addEventListener("DOMContentLoaded", function () {

    var inputNIM = document.getElementById("fnim");
    var errorNIM = inputNIM.nextElementSibling; 

    inputNIM.addEventListener("input", function () {
        var nimValue = inputNIM.value;

        if (!/^[0-9]*$/.test(nimValue)) {
            errorNIM.textContent = "NIM Harus Berisi Angka";
            inputNIM.classList.add("input-error"); 
        } else {
            errorNIM.textContent = ""; 
            inputNIM.classList.remove("input-error"); 
        }
    });
});